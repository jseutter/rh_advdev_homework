...
# Give the marker process access..
...
oc set probe dc/tasks --readiness --get-url=http://:8080/ --initial-delay-seconds=120 --timeout-seconds=5 -n ${GUID}-tasks-dev
oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=120 --timeout-seconds=5 -n ${GUID}-tasks-dev
#oc set probe dc/tasks --readiness --get-url=http://:8080/ --initial-delay-seconds=300 --timeout-seconds=15 -n ${GUID}-tasks-dev
#oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=300 --timeout-seconds=15 -n ${GUID}-tasks-dev
